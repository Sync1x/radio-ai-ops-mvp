...
const navItems: Array<{ id: View; label: string }> = [
  ...
  { id: "specSpot", label: "Spec Spot Generator" },
  { id: "hyperlocalNews", label: "Hyperlocal News" },
  { id: "fccDrafter", label: "FCC Drafter" },
  { id: "proposalGenerator", label: "Proposal Generator" },
  { id: "socialQueue", label: "Social Queue" },
  { id: "copyrightLogger", label: "Copyright Logger" },
  { id: "aircheckLogger", label: "Aircheck Logger" }
];
